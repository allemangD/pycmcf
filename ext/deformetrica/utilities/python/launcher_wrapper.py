...
def perform_shooting(
    template_specs,
    initial_control_points_file,
    initial_momenta_file,
    deformation_kernel_width,
    t0=0.0,
    tmin=0.0,
    tmax=1,
...
if __name__ == "__main__":
    ...
    template_file_1 = (
        "../../examples/shooting/landmark/3d/brain_structures/data/amyg_prototype.vtk"
    )
    template_file_2 = (
        "../../examples/shooting/landmark/3d/brain_structures/data/hippo_prototype.vtk"
    )
    cp_file = (
        "../../examples/shooting/landmark/3d/brain_structures/data/ControlPoints.txt"
    )
    momenta_file = (
        "../../examples/shooting/landmark/3d/brain_structures/data/Momenta.txt"
    )
    ...
    template_specs["amyg"] = {
        ...
        "noise_std": 0.1,
        "filename": template_file_1,
    }  # no more info needed for shooting
    template_specs["hippo"] = {
        "deformable_object_type": "surfacemesh",
        "noise_std": 0.1,
