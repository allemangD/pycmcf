...
class GeodesicRegression(AbstractStatisticalModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        AbstractStatisticalModel.__init__(
            self, name="GeodesicRegression", gpu_mode=gpu_mode
        )
    ...
    def compute_log_likelihood(
        ...
        if with_grad:
            ...
            gradient = {
                key: value.data.cpu().numpy() for key, value in gradient.items()
            }
    ...
    def _write_model_predictions(
        self, output_dir, dataset=None, write_adjoint_parameters=False
    ):
