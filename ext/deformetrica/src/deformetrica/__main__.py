...
def main():
    ...
    common_parser.add_argument(
        "--parameters", "-p", type=str, help="parameters xml file"
    )
    ...
    parser_estimate = subparsers.add_parser(
        "estimate", add_help=False, parents=[common_parser]
    )
    ...
    # initialize command
    parser_initialize = subparsers.add_parser(
        "finalize", add_help=False, parents=[common_parser]
    )
    parser_initialize.add_argument("model", type=str, help="model xml file")
