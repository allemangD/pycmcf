...
from tests.functional_tests.data.longitudinal_atlas.digits.run import (
    LongitudinalAtlasDigits,
)
from tests.functional_tests.data.longitudinal_atlas.hippocampi.run import (
    LongitudinalAtlasHippocampi,
)
from tests.functional_tests.data.longitudinal_atlas.starmen.run import (
    LongitudinalAtlasStarmen,
)
from tests.functional_tests.data.parallel_transport.alien.run import (
    ParallelTransportAlien,
)
from tests.functional_tests.data.parallel_transport.snowman.run import (
    ParallelTransportSnowman,
)
from tests.functional_tests.data.principal_geodesic_analysis.digits.run import (
